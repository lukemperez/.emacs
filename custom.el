(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-ref solarized-emacs solarized-theme zenburn-theme writeroom-mode darkroom-mode auctex markdown-mode polymode pandoc-mode paganini-theme use-package))))
(custom-set-faces
