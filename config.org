...
I need to write yaml files sometimes and need highlighting for those. The simpliest I have this, [[https://github.com/yoshiki/yaml-mode][yaml-mode]]. I just pulled the default recommended setup so that both =.yaml= and =.yml= files activate yaml-mode.
